...
var mstatistics = {
    ...
    ,sp_STATISTICS_QUESTION_GROUP_DATA_20180727: function(campaign_code, group_code, q_code, quest_num, callback) {
        var connection = mysql_dbc.init();
        var query = " call sp_STATISTICS_QUESTION_GROUP_DATA_20180727(?, ?, ?, ?)";
        var params = [];
        params.push(campaign_code);
        params.push(group_code);
        params.push(q_code);
