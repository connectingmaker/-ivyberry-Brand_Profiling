...
var mnotice = {
    ...
    var connection = mysql_dbc.init();
        ...
        var query = " SELECT SEQ,SUBJECT,CONTENTS,USE_YN,INSERT_DATETIME,CASE USE_YN WHEN 'N' THEN '미노출' WHEN 'Y' THEN '노출' END USE_YN_TEXT FROM NOTICE ORDER BY INSERT_DATETIME";
        var params = [];
        params.push();
